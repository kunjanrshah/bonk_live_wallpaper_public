...
public class BonkSettings extends PreferenceActivity implements SharedPreferences.OnSharedPreferenceChangeListener, Preference.OnPreferenceClickListener {
	...
	protected void onCreate(Bundle icicle) {
		...
		findPreference(SOUND_USER_KEY).setOnPreferenceClickListener(this);
		soundList = (ListPreference) findPreference(SOUND_LIST_KEY);
		soundListOrigSize = soundList.getEntries().length;
		updateSoundList();
		return;
	}
